...
// classes prefixed with DNSpire. The framework's module name is configured via
// the `-o DNSpireCore.xcframework` argument; the Swift module name comes from
// the xcframework's own Module map and ends up as `DNSpireCore`.
import DNSpireCore
...
/// DNSpireTunnel handle and keeps @Published state for the UI to observe.
@MainActor
final class TunnelController: ObservableObject {
    ...
    private var tunnel: DNSpireTunnel?
...
// DNSpireLogCallback and DNSpireStatusCallback are gomobile-generated
